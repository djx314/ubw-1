...
trait GroupSlickSelect[D] extends Atomic[D] {
  type SourceType
  type DataType
  type TargetType
...
trait GroupByColumnWrap[T] extends AtomicPathImpl[T]

sealed abstract trait GroupableColumnAbs[E] extends Atomic[E] {
}
